...
// WLAN-Daten
const char* ssid = "clx";
const char* password = "cl1xCom00_";

// Pin-Definitionen
#define PIR_PIN 5           // Bewegungssensor
#define LED_RING_PIN 11     // LED-Ring
...
const char* galleryUrl = "https://im4-imbild.ch/public/gallery.html";
WebServer server(80);
